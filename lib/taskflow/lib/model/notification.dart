...
class Notification1 {
  /// Returns a new [Notification1] instance.
  Notification1({
    this.title,
    this.body,
    this.scheduledTime,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Notification1 &&
     other.title == title &&
     other.body == body &&
  ...
  /// Returns a new [Notification1] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Notification1? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<Notification1>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Notification1>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Notification1.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Notification1> mapFromJson(dynamic json) {
    final map = <String, Notification1>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Notification1.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<Notification1>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Notification1>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Notification1.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
