...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationRecipient")]
    public partial class NotificationRecipient : IEquatable<NotificationRecipient>, IValidatableObject
    {
        ...
        public NotificationRecipient(int recipientId = default(int), User recipient = default(User), int id = default(int), bool deleted = default(bool), DateTime createdDate = default(DateTime))
        {
