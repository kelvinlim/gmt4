...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ConnectionType : IEquatable<ConnectionType>, IValidatableObject
    {
        /// <summary>
        ...
        public ConnectionType(string name = default(string), int id = default(int), bool deleted = default(bool), DateTime createdDate = default(DateTime))
        {
            this.Name = name;
            this.Id = id;
        ...
        /// <summary>
        /// Returns true if ConnectionType instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectionType to be compared</param>
        /// <returns>Boolean</returns>
