...
namespace Org.OpenAPITools.Model
{
    ...
    /// Stimulation
    /// </summary>
    [DataContract(Name = "Stimulation")]
    public partial class Stimulation : IEquatable<Stimulation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Stimulation" /> class.
        /// </summary>
        ...
        public Stimulation(int stimulationTypeId = default(int), StimulationType stimulationType = default(StimulationType), int id = default(int), bool deleted = default(bool), DateTime createdDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as Stimulation);
        }

        /// <summary>
        /// Returns true if Stimulation instances are equal
        /// </summary>
        /// <param name="input">Instance of Stimulation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Stimulation input)
        {
            if (input == null)
            {
                return false;
