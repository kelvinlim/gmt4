...
void main() {
  ...
  group('test Connection', () {
    ...
    // List<ConnectionEvent> events (default value: const [])
    test('to test the property `events`', () async {
      // TODO
    });

    // int connectionTypeId
    test('to test the property `connectionTypeId`', () async {
      // TODO
    });
    ...
    // int populationId
    test('to test the property `populationId`', () async {
      // TODO
    });

    // Population population
    test('to test the property `population`', () async {
      // TODO
    });
